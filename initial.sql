...
CREATE TABLE `ai_market_maker_history` (
  ...
  `details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`details`)),
...
CREATE TABLE `default_pages` (
  ...
  `title` varchar(255) NOT NULL,
  `variables` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Structured data for home page editing (texts, images, etc.)' CHECK (json_valid(`variables`)),
  `content` text COMMENT 'HTML/markdown content for legal pages',
  `meta` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'SEO metadata and other page settings' CHECK (json_valid(`meta`)),
...
CREATE TABLE `deposit_gateway` (
  ...
  `currencies` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`currencies`)),
  `fixedFee` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`fixedFee`)),
  `percentageFee` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`percentageFee`)),
  `minAmount` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`minAmount`)),
  `maxAmount` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`maxAmount`)),
...
CREATE TABLE `deposit_method` (
  ...
  `customFields` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Custom form fields required for this deposit method' CHECK (json_valid(`customFields`)),
...
CREATE TABLE `ecosystem_token` (
  ...
  `limits` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`limits`)),
  `icon` varchar(1000) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
  `fee` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`fee`)),
  PRIMARY KEY (`id`),
...
CREATE TABLE `exchange_order` (
  ...
  `trades` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Array of individual trades that make up this order' CHECK (json_valid(`trades`)),
...
CREATE TABLE `faqs` (
  ...
  `relatedFaqIds` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`relatedFaqIds`)),
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
  `image` varchar(191) DEFAULT NULL,
...
CREATE TABLE `gateway_api_key` (
  ...
  `permissions` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`permissions`)),
  `ipWhitelist` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`ipWhitelist`)),
  ...
  `allowedWalletTypes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`allowedWalletTypes`)),
  PRIMARY KEY (`id`),
...
CREATE TABLE `gateway_payment` (
  ...
  `description` text,
  `metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`metadata`)),
  `lineItems` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`lineItems`)),
  `customerEmail` varchar(255) DEFAULT NULL,
  `customerName` varchar(191) DEFAULT NULL,
  `billingAddress` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`billingAddress`)),
  ...
  `updatedAt` datetime NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
  `allocations` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Array of wallet allocations used for this payment' CHECK (json_valid(`allocations`)),
  PRIMARY KEY (`id`),
...
CREATE TABLE `ico_token_vesting` (
  ...
  `releaseSchedule` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'JSON array of milestone releases [{date, percentage, amount}]' CHECK (json_valid(`releaseSchedule`)),
...
CREATE TABLE `ico_token_vesting_release` (
  ...
  `metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Additional metadata about the release' CHECK (json_valid(`metadata`)),
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `kyc_level` (
  ...
  `fields` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Required fields and documents for this KYC level' CHECK (json_valid(`fields`)),
  `features` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Features and benefits unlocked at this KYC level' CHECK (json_valid(`features`)),
...
CREATE TABLE `kyc_verification_result` (
  ...
  `checks` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Detailed verification checks and their results' CHECK (json_valid(`checks`)),
  `documentVerifications` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Results of document verification checks' CHECK (json_valid(`documentVerifications`)),
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `nft_dispute` (
  ...
  `title` varchar(255) NOT NULL,
  `description` text NOT NULL,
  `evidence` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`evidence`)),
  `resolution` text,
...
CREATE TABLE `nft_token` (
  ...
  `description` text,
  `image` varchar(1000) DEFAULT NULL,
  `attributes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`attributes`)),
...
CREATE TABLE `notification` (
  ...
  `details` text,
  `actions` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`actions`)),
...
CREATE TABLE `p2p_disputes` (
  ...
  `resolution` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`resolution`)),
  `resolvedOn` datetime DEFAULT NULL,
  `messages` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`messages`)),
  `evidence` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`evidence`)),
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
  `activityLog` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`activityLog`)),
  PRIMARY KEY (`id`),
  KEY `tradeId` (`tradeId`),
...
CREATE TABLE `p2p_offers` (
  ...
  `locationSettings` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`locationSettings`)),
  `userRequirements` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`userRequirements`)),
  `status` enum('DRAFT','PENDING_APPROVAL','ACTIVE','PAUSED','COMPLETED','CANCELLED','REJECTED','EXPIRED') NOT NULL DEFAULT 'DRAFT',
  `views` int(11) NOT NULL DEFAULT 0,
  `systemTags` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`systemTags`)),
  `adminNotes` text,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
...
CREATE TABLE `p2p_payment_methods` (
  ...
  `metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Flexible key-value pairs for payment details (e.g., PayPal Email, Bank Account, etc.)' CHECK (json_valid(`metadata`)),
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
...
CREATE TABLE `p2p_trades` (
  ...
  `paymentDetails` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`paymentDetails`)),
  `timeline` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`timeline`)),
  `terms` text,
...
CREATE TABLE `page` (
  ...
  `content` longtext COMMENT 'Main content/body of the page (HTML or Markdown)',
...
CREATE TABLE `support_ticket` (
  ...
  `messages` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Array of chat messages between user and support agent' CHECK (json_valid(`messages`)),
  ...
  `tags` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Tags for search/filter (string array)' CHECK (json_valid(`tags`)),
...
CREATE TABLE `user` (
  ...
  `profile` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Additional user profile information in JSON format' CHECK (json_valid(`profile`)),
  ...
  `settings` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'User notification and preference settings' CHECK (json_valid(`settings`)),
  PRIMARY KEY (`id`),
...
CREATE TABLE `wallet` (
  ...
  `updatedAt` datetime NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
  `address` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Blockchain addresses associated with this wallet' CHECK (json_valid(`address`)),
  PRIMARY KEY (`id`),
...
CREATE TABLE `wallet_pnl` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `userId` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `balances` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Profit and loss balances for different wallet types (FIAT, SPOT, ECO)' CHECK (json_valid(`balances`)),
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
...
CREATE TABLE `withdraw_method` (
  ...
  `customFields` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Custom form fields required for this withdrawal method' CHECK (json_valid(`customFields`)),
